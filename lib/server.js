 ...
 * @param {string} opts.coin[='dsr'] - The coin for this wallet (desire).
 ...
 * @param {string} opts.coin[='dsr'] - The expected coin for this wallet (desire).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['dsr'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='dsr'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'dsr'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'dsr'] - The coin for this transaction.
